...
#define COMBO_READONLY_BK_COLOR     (RGB(255, 255, 255))    // 白色  // (RGB(225, 225, 225))  // 灰色
...
#define COMBO_NORMAL_MOUSE_ON_EDIT_COLOR   (RGB(0, 120, 215))   // 蓝色       //(RGB(23, 23, 23))  // 接近黑色
...
public:
    ...
    BOOL m_bMouseHoverOnDelBtn;//用于判选中项按钮的状态，0正常,1鼠标停留。
    CRect m_rcDelButton;//选中项按钮大小
    CRect m_rcArrow;
    CRect m_rcItem;
    BOOL m_bMouseOverBox;
    BOOL m_bMouseOverArrow;
